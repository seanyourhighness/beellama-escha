#!/usr/bin/env bash
# P-ARCH-18 original-LowGPU matched prefill control in BeeLlama.
#
# Usage: escha-parch18-control.sh <label> <model.gguf> <evidence-dir> [reps]
# Identical methodology to escha-parch17-control.sh: immutable shared 2,048-ID
# prefill, P-ARCH-15 candidate binary, graphs on, no instrumentation.
set -u
