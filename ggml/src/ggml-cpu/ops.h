...
void ggml_compute_forward_lowgpu_get_rows(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_lowgpu_mul_mat(const struct ggml_compute_params * params, struct ggml_tensor * dst);
