...
| P020 / P-ARCH-20 | Reproduce native Escha mixed policy with a Bee FP16 MMA accumulator only for `M=2048, IC=5120, OC=17408, K2`; all layout/staging/geometry unchanged | PASS: compile-time flag `ESCHA_MMA_FP16ACC_EXPERIMENT`; runtime shape predicate; isolated symbol has 32 `HMMA.16816.F16` and 0 `.F32` versus FP32 twin 0/32 | Not run: performance hard gate failed decisively, so no quality claim is made | FP32 median 929.039 ms / 2204.43 tok/s; FP16 median 1339.906 ms / 1528.47 tok/s; **+410.867 ms / 44.22% slower** | `REJECTED` | `/mnt/d/CODEX WORKSPACE/escha-w2-lowgpu/evidence/P-ARCH-20/2026-08-30/{control-001,fp16acc-001}/`; arithmetic-only port does not transfer native Escha's gain; pivot to P-ARCH-21 direct-fragment/shared-B bypass |
