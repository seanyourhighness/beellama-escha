...
enum llm_tensor {
    ...
    // LowGPU v1 3-bit vocab sidecars (embed + LM head), see ggml_lowgpu_get_rows
    LLM_TENSOR_TOKEN_EMBD_LOWGPU_CODE,
    LLM_TENSOR_TOKEN_EMBD_LOWGPU_SCALE,
    LLM_TENSOR_TOKEN_EMBD_LOWGPU_ZP,
    LLM_TENSOR_OUTPUT_LOWGPU_CODE,
    LLM_TENSOR_OUTPUT_LOWGPU_SCALE,
    LLM_TENSOR_OUTPUT_LOWGPU_ZP,
